...
public class VerifyFileDocx extends UiAutomatorTestCase {
	...
	private final static String FILE_NAME = "HR-DEPENDENT REGISTRATION FORM.fcs";
	...
	public void testDemo() throws UiObjectNotFoundException, RemoteException,
		...
		loggerd(VerifyFileDocx.class.getName(), "Start Testing");

		loggerd(VerifyFileDocx.class.getName(), "Launch FileString App");
		launchFileStringApp(APP_NAME);

		loggerd(VerifyFileDocx.class.getName(), "Sign In");
		signIn(EMAIL_SHARE_FILE, PASSWORD);

		loggerd(VerifyFileDocx.class.getName(), "Sleeping 60s ...");
		Thread.sleep(60000);
		...
		loggerd(VerifyFileDocx.class.getName(), "Sign Out");
		signOut();

		loggerd(VerifyFileDocx.class.getName(), "Test Complete");
	}
