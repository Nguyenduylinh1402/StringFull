...
public class VerifyFilePng extends UiAutomatorTestCase {
	...
	private final static String FILE_NAME = "Screenshot tao2.fcs";
	...
	public void testDemo() throws UiObjectNotFoundException, RemoteException,
		...
		loggerd(VerifyFilePng.class.getName(), "Start Testing");

		loggerd(VerifyFilePng.class.getName(), "Launch FileString App");
		launchFileStringApp(APP_NAME);

		loggerd(VerifyFilePng.class.getName(), "Sign In");
		signIn(EMAIL_SHARE_FILE, PASSWORD);

		loggerd(VerifyFilePng.class.getName(), "Sleeping 60s ...");
		Thread.sleep(60000);
		...
		loggerd(VerifyFilePng.class.getName(), "Sign Out");
		signOut();

		loggerd(VerifyFilePng.class.getName(), "Test Complete");
	}
