...
public class VerifyFileJpg extends UiAutomatorTestCase {
	...
	private final static String FILE_NAME = "C360_2014-11-28-22-04-59-538.fcs";
	...
	public void testDemo() throws UiObjectNotFoundException, RemoteException,
		...
		loggerd(VerifyFileJpg.class.getName(), "Start Testing");

		loggerd(VerifyFileJpg.class.getName(), "Launch FileString App");
		launchFileStringApp(APP_NAME);

		loggerd(VerifyFileJpg.class.getName(), "Sign In");
		signIn(EMAIL_SHARE_FILE, PASSWORD);

		loggerd(VerifyFileJpg.class.getName(), "Sleeping 60s ...");
		Thread.sleep(60000);
		...
		loggerd(VerifyFileJpg.class.getName(), "Sign Out");
		signOut();

		loggerd(VerifyFileJpg.class.getName(), "Test Complete");
	}
