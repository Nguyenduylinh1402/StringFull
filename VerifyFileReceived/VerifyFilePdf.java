...
public class VerifyFilePdf extends UiAutomatorTestCase {
	...
	private final static String FILE_NAME = "English Classes-Preintermediate.fcs";
	...
	public void testDemo() throws UiObjectNotFoundException, RemoteException,
		...
		loggerd(VerifyFilePdf.class.getName(), "Start Testing");

		loggerd(VerifyFilePdf.class.getName(), "Launch FileString App");
		launchFileStringApp(APP_NAME);

		loggerd(VerifyFilePdf.class.getName(), "Sign In");
		signIn(EMAIL_SHARE_FILE, PASSWORD);

		loggerd(VerifyFilePdf.class.getName(), "Sleeping 60s ...");
		Thread.sleep(60000);
		...
		loggerd(VerifyFilePdf.class.getName(), "Sign Out");
		signOut();

		loggerd(VerifyFilePdf.class.getName(), "Test Complete");
	}
