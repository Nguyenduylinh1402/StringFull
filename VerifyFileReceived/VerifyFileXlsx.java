...
public class VerifyFileXlsx extends UiAutomatorTestCase {
	...
	private final static String FILE_NAME = "timetable-PNV2M & 2T_week 36.fcs";
	...
	public void testDemo() throws UiObjectNotFoundException, RemoteException,
		...
		loggerd(VerifyFileXlsx.class.getName(), "Start Testing");

		loggerd(VerifyFileXlsx.class.getName(), "Launch FileString App");
		launchFileStringApp(APP_NAME);

		loggerd(VerifyFileXlsx.class.getName(), "Sign In");
		signIn(EMAIL_SHARE_FILE, PASSWORD);

		loggerd(VerifyFileXlsx.class.getName(), "Sleeping 60s ...");
		Thread.sleep(60000);
		...
		loggerd(VerifyFileXlsx.class.getName(), "Sign Out");
		signOut();

		loggerd(VerifyFileXlsx.class.getName(), "Test Complete");
	}
